...
public class AgentSenses {
   ...
   /* public AgentAction makeDecision(ArrayList<CollisionUtil.Collision> collisions){
        ...
        - Agents should move towards obstacles, agents.
        - If no agent or obstacle in sight, move in a different direction. (50% chance of going forward, 50% chance of changing directions)
         */
    ...
    /*public void visualSearch(Configuration conf, Simulation sim){
        ...
        if (agent1Loc.getX() > agent2Loc.getX()){
            ...
            CollisionUtil.Collision agent1ColForward = CollisionUtil.castRay(conf, forwardRayOne, 0.25, 3.0, 1, agents.getAgent1(sim));
            CollisionUtil.Collision agent2ColForward = CollisionUtil.castRay(conf, forwardRayTwo, 0.25, 3.0, 1, agents.getAgent1(sim));
            ...
            CollisionUtil.Collision agent1ColLeft = CollisionUtil.castRay(conf, leftRayOne, 0.25, 3.0, 1, agents.getAgent1(sim));
            CollisionUtil.Collision agent2ColLeft = CollisionUtil.castRay(conf, leftRayTwo, 0.25, 3.0, 1, agents.getAgent1(sim));
            ...
            CollisionUtil.Collision agent1ColRight = CollisionUtil.castRay(conf, rightRayOne, 0.25, 3.0, 1.0, agents.getAgent1(sim));
            CollisionUtil.Collision agent2ColRight = CollisionUtil.castRay(conf, rightRayTwo, 0.25, 3.0, 1.0, agents.getAgent1(sim));
        ...
        // if Agent 2 is in front of Agent 1, cast rays from Agent 2 to L/R/F
            ...
            Ray rightRayOne = new Ray(agent1Loc, rightDirOne);
            Ray rightRayTwo = new Ray(agent1Loc, rightDirTwo);
            CollisionUtil.Collision agent1ColRight = CollisionUtil.castRay(conf, rightRayOne, 0.25, 3.0, 1, agents.getAgent1(sim));
            CollisionUtil.Collision agent2ColRight = CollisionUtil.castRay(conf, rightRayTwo, 0.25, 3.0, 1, agents.getAgent1(sim));
        ...
        // if Agent 1 is to the left of Agent 2, cast rays from Agent 1 to R/F/B
            ...
            if (agent1Loc.getY() < agent2Loc.getY()){
                ...
                CollisionUtil.Collision colForward = CollisionUtil.castRay(conf, forwardRay, 0.25, 3.0, 1, agents.getAgent1(sim));

                Point3D leftDir = new Point3D(agent1Loc.getX(), agent1Loc.getY(), agent1Loc.getZ() - 1);
                Ray leftRay = new Ray(agent1Loc, leftDir);
                CollisionUtil.Collision colLeft = CollisionUtil.castRay(conf, leftRay, 0.25, 3.0, 1, agents.getAgent1(sim));

                Point3D rightDir = new Point3D(agent1Loc.getX(), agent1Loc.getY(), agent1Loc.getZ() + 1);
                Ray rightRay = new Ray(agent1Loc, rightDir);
                CollisionUtil.Collision colRight = CollisionUtil.castRay(conf, rightRay, 0.25, 3.0, 1, agents.getAgent1(sim));

                Point3D backDir = new Point3D(agent1Loc.getX() - 1, agent1Loc.getY(), agent1Loc.getZ());
                Ray backRay = new Ray(agent1Loc, backDir);
                CollisionUtil.Collision colBack = CollisionUtil.castRay(conf, backRay, 0.25, 3.0, 1, agents.getAgent1(sim));
